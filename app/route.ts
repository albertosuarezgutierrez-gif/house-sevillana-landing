...
const K = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indzd2JlaGxjdXhxeHlpbm91c3FsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NjI0NTY5MiwiZXhwIjoyMDkxODIxNjkyfQ.MhMSWQxXOcNqmF1VKNIDUxX0OJ7M5yMDEagexFPcSbw';
...
export async function GET() {
  ...
  const docStart = rawText.indexOf('<!DOCTYPE html>');
  const html = (docStart>=0 ? rawText.slice(docStart) : rawText)
    .replace('</head>',GA+'</head>');
